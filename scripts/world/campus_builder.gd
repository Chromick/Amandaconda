...
func _build_interior_hub() -> void:
	...
	_way_sign(Vector3(0, 2.2, 16), "↓ SAFEZONE\n15 latas · T skill", Color(0.45, 1.0, 0.65))
	...
	_way_sign(Vector3(0, 2.1, -8), "CORREDOR CENTRAL\n↑ A Porta · ↓ Safe", Color(0.9, 0.9, 0.75))
	_way_sign(Vector3(-8, 2.0, -26), "GATE · A PORTA\nNet à frente", Color(1.0, 0.4, 0.5))
	_way_sign(Vector3(8, 2.0, -26), "CUIDADO · Chatana\nà direita", Color(0.55, 0.95, 1.0))
	...
	_way_sign(Vector3(-26, 2.0, -4), "FRANJA OESTE\nChatana fringe", Color(0.55, 0.95, 1.0))
	_way_sign(Vector3(0, 2.2, -30), "A PORTA\núltima sala", Color(1.0, 0.35, 0.5))
	_way_sign(Vector3(-20, 2.0, -20), "OESTE PROFUNDO\nKB · fringe", Color(0.7, 0.95, 1.0))
	...
	_street_lamp(Vector3(16, 0, 8))
	_street_lamp(Vector3(0, 0, -18))
	_street_lamp(Vector3(-6, 0, -28))
	_street_lamp(Vector3(6, 0, -28))
	_street_lamp(Vector3(-22, 0, -16))
	_street_lamp(Vector3(22, 0, -12))
	_street_lamp(Vector3(-8, 0, 16))
	_street_lamp(Vector3(8, 0, 16))
	_street_lamp(Vector3(-8, 0, 18))
	_street_lamp(Vector3(8, 0, 18))
	_street_lamp(Vector3(0, 0, 10))
	_street_lamp(Vector3(-14, 0, -10))
	_street_lamp(Vector3(14, 0, -10))
	_street_lamp(Vector3(-4, 0, -14))
	_street_lamp(Vector3(4, 0, -14))
	_street_lamp(Vector3(-10, 0, -22))
	_street_lamp(Vector3(10, 0, -22))
	_street_lamp(Vector3(-18, 0, 12))
	_street_lamp(Vector3(18, 0, 10))
	_street_lamp(Vector3(-24, 0, 0))
	_street_lamp(Vector3(24, 0, 0))
	_street_lamp(Vector3(-26, 0, -8))
	_street_lamp(Vector3(26, 0, -8))
...
func _spawn_gameplay() -> void:
	...
	_spawn_enemy(PORTARA, Vector3(10, 1, 12), "modular/Worker.gltf", 1.18, Color(0.78, 0.62, 0.5, 1))
	_spawn_enemy(NET, Vector3(-10, 1, -28), "modular/Casual_Hoodie.gltf", 1.05, Color(0.82, 0.48, 1, 1))
	_spawn_enemy(CHATANA, Vector3(14, 1, -26), "modular/Punk.gltf", 1.04, Color(0.65, 0.95, 1, 1))
	...
	_spawn_enemy(NET, Vector3(-16, 1, 8), "modular/Punk.gltf", 1.05, Color(0.85, 0.4, 1, 1))
	_spawn_enemy(CHATANA, Vector3(16, 1, 6), "modular/Casual_2.gltf", 1.03, Color(0.58, 0.92, 1, 1))
	_spawn_enemy(PORTARA, Vector3(22, 1, -4), "modular/Suit.gltf", 1.15, Color(0.68, 0.55, 0.45, 1))
	_spawn_enemy(NET, Vector3(0, 1, -12), "modular/Swat.gltf", 1.08, Color(0.9, 0.45, 1, 1))
	_spawn_enemy(CHATANA, Vector3(-24, 1, -4), "modular/Farmer.gltf", 1.04, Color(0.52, 0.88, 0.95, 1))
	_spawn_enemy(PORTARA, Vector3(-8, 1, -20), "modular/Worker.gltf", 1.19, Color(0.76, 0.6, 0.48, 1))
	_spawn_enemy(NET, Vector3(10, 1, -20), "modular/Casual_Hoodie.gltf", 1.06, Color(0.8, 0.5, 1, 1))
	_spawn_enemy(CHATANA, Vector3(-2, 1, 8), "modular/Beach.gltf", 1.02, Color(0.5, 0.9, 0.92, 1))
	_spawn_enemy(PORTARA, Vector3(8, 1, -10), "modular/King.gltf", 1.21, Color(0.74, 0.58, 0.46, 1))
	_spawn_enemy(NET, Vector3(-14, 1, -26), "modular/Spacesuit.gltf", 1.07, Color(0.82, 0.4, 0.95, 1))
	_spawn_enemy(CHATANA, Vector3(24, 1, 2), "modular/Punk.gltf", 1.03, Color(0.6, 0.95, 1, 1))
	_spawn_enemy(PORTARA, Vector3(-22, 1, 12), "modular/Adventurer.gltf", 1.16, Color(0.78, 0.62, 0.5, 1))
	_spawn_enemy(NET, Vector3(16, 1, -26), "modular/Swat.gltf", 1.05, Color(0.88, 0.48, 1, 1))
	_spawn_enemy(CHATANA, Vector3(0, 1, -16), "modular/Casual_2.gltf", 1.04, Color(0.55, 0.92, 0.98, 1))
	_spawn_enemy(PORTARA, Vector3(26, 1, -12), "modular/Suit.gltf", 1.17, Color(0.7, 0.56, 0.46, 1))
	_spawn_enemy(NET, Vector3(-6, 1, -8), "modular/Punk.gltf", 1.05, Color(0.86, 0.42, 1, 1))
	_spawn_enemy(CHATANA, Vector3(12, 1, 14), "modular/Farmer.gltf", 1.03, Color(0.5, 0.9, 0.95, 1))
	_spawn_enemy(CHATANA, Vector3(-28, 1, -6), "modular/Casual_2.gltf", 1.04, Color(0.48, 0.92, 1, 1))
	_spawn_enemy(NET, Vector3(28, 1, -10), "modular/Spacesuit.gltf", 1.06, Color(0.84, 0.44, 0.98, 1))
	_spawn_enemy(PORTARA, Vector3(-4, 1, 20), "modular/Worker.gltf", 1.18, Color(0.76, 0.6, 0.48, 1))
	...
	_spawn_enemy(CHATANA, Vector3(-18, 1, 14), "modular/Farmer.gltf", 1.03, Color(0.5, 0.9, 0.95, 1))
	_spawn_enemy(NET, Vector3(18, 1, 12), "modular/Casual_Hoodie.gltf", 1.05, Color(0.82, 0.48, 1, 1))
	_spawn_enemy(PORTARA, Vector3(8, 1, 18), "modular/Suit.gltf", 1.15, Color(0.7, 0.55, 0.45, 1))
	_spawn_enemy(CHATANA, Vector3(-8, 1, 18), "modular/Beach.gltf", 1.02, Color(0.48, 0.9, 0.95, 1))
	_spawn_enemy(NET, Vector3(0, 1, 16), "modular/Punk.gltf", 1.04, Color(0.85, 0.45, 1, 1))
	_spawn_enemy(PORTARA, Vector3(-14, 1, -30), "modular/King.gltf", 1.18, Color(0.72, 0.58, 0.46, 1))
	_spawn_enemy(CHATANA, Vector3(14, 1, -30), "modular/Casual_2.gltf", 1.03, Color(0.55, 0.92, 0.98, 1))
	_spawn_enemy(NET, Vector3(-24, 1, 10), "modular/Spacesuit.gltf", 1.05, Color(0.8, 0.42, 0.95, 1))
	...
	_spawn(BYTES, Vector3(10, 0.6, -4))
	_spawn(BYTES, Vector3(-28, 0.6, -6))
	_spawn(BYTES, Vector3(28, 0.6, -10))
	_spawn(BYTES, Vector3(-28, 0.6, -24))
	_spawn(BYTES, Vector3(28, 0.6, -24))
	...
	_spawn(BYTES, Vector3(0, 0.6, -14))
	_spawn(BYTES, Vector3(-12, 0.6, 12))
	_spawn(BYTES, Vector3(12, 0.6, 10))
	_spawn(BYTES, Vector3(-22, 0.6, -12))
	_spawn(BYTES, Vector3(4, 0.6, -26))
	_spawn(BYTES, Vector3(-4, 0.6, -26))
	_spawn(BYTES, Vector3(20, 0.6, 8))
	_spawn(BYTES, Vector3(-8, 0.6, -28))
	_spawn(BYTES, Vector3(8, 0.6, -28))
	_spawn(BYTES, Vector3(0, 0.6, 8))
	_spawn(BYTES, Vector3(-16, 0.6, -24))
	_spawn(BYTES, Vector3(16, 0.6, -22))
	_spawn(BYTES, Vector3(-5, 0.6, -8))
	_spawn(BYTES, Vector3(5, 0.6, -8))
	_spawn(BYTES, Vector3(-18, 0.6, 2))
	_spawn(BYTES, Vector3(22, 0.6, -16))
	_spawn(BYTES, Vector3(-22, 0.6, -14))
	_spawn(BYTES, Vector3(2, 0.6, -4))
	_spawn(BYTES, Vector3(-14, 0.6, -18))
	_spawn(BYTES, Vector3(14, 0.6, -16))
	_spawn(BYTES, Vector3(0, 0.6, -22))
	_spawn(BYTES, Vector3(-10, 0.6, 6))
	_spawn(BYTES, Vector3(10, 0.6, 6))
	_spawn(BYTES, Vector3(-3, 0.6, -10))
	_spawn(BYTES, Vector3(8, 0.6, 14))
	_spawn(BYTES, Vector3(-8, 0.6, 14))
	_spawn(BYTES, Vector3(0, 0.6, -16))
	_spawn(BYTES, Vector3(-20, 0.6, 0))
	_spawn(BYTES, Vector3(20, 0.6, 0))
	_spawn(BYTES, Vector3(-4, 0.6, 6))
	_spawn(BYTES, Vector3(12, 0.6, -6))
	_spawn(BYTES, Vector3(-12, 0.6, -6))
	_spawn(BYTES, Vector3(4, 0.6, 16))
	_spawn(BYTES, Vector3(-6, 0.6, -4))
	_spawn(BYTES, Vector3(6, 0.6, -4))
	_spawn(BYTES, Vector3(0, 0.6, 4))
	_spawn(BYTES, Vector3(-15, 0.6, -8))
	_spawn(BYTES, Vector3(15, 0.6, -8))
	_spawn(BYTES, Vector3(-2, 0.6, 12))
	_spawn(BYTES, Vector3(18, 0.6, 4))
	_spawn(BYTES, Vector3(-18, 0.6, 4))
	_spawn(BYTES, Vector3(8, 0.6, -18))
	_spawn(BYTES, Vector3(-14, 0.6, 14))
	_spawn(BYTES, Vector3(14, 0.6, 12))
	_spawn(BYTES, Vector3(0, 0.6, -8))
	_spawn(BYTES, Vector3(-22, 0.6, 10))
	_spawn(BYTES, Vector3(22, 0.6, 8))
	_spawn(BYTES, Vector3(-8, 0.6, -12))
	_spawn(BYTES, Vector3(16, 0.6, -14))
	_spawn(BYTES, Vector3(-16, 0.6, -10))
	_spawn(BYTES, Vector3(2, 0.6, 18))
	_spawn(BYTES, Vector3(-20, 0.6, -18))
	_spawn(BYTES, Vector3(20, 0.6, -20))
	_spawn(BYTES, Vector3(6, 0.6, 2))
	_spawn(BYTES, Vector3(-6, 0.6, 16))
	_spawn(BYTES, Vector3(10, 0.6, -2))
	_spawn(BYTES, Vector3(-10, 0.6, -2))
	_spawn(BYTES, Vector3(0, 0.6, -26))
	_spawn(BYTES, Vector3(-12, 0.6, 0))
	_spawn(BYTES, Vector3(12, 0.6, -4))
	_spawn(BYTES, Vector3(-4, 0.6, -22))
	_spawn(BYTES, Vector3(4, 0.6, -22))
	_spawn(BYTES, Vector3(-24, 0.6, -8))
	_spawn(BYTES, Vector3(24, 0.6, -10))
	_spawn(BYTES, Vector3(-6, 0.6, -18))
	_spawn(BYTES, Vector3(6, 0.6, -18))
	_spawn(BYTES, Vector3(-8, 0.6, 18))
	...
	_spawn(BYTES, Vector3(30, 0.6, 0))
	_spawn(BYTES, Vector3(-30, 0.6, 4))
	_spawn(BYTES, Vector3(30, 0.6, -4))
	_spawn(BYTES, Vector3(0, 0.6, -34))
	...
	var pen_f3 := PENDRIVE.instantiate()
	pen_f3.kind = "fisico"
	spawns_root.add_child(pen_f3)
	pen_f3.global_position = Vector3(0, 0.5, -22)
	var pen_e3 := PENDRIVE.instantiate()
	pen_e3.kind = "especial"
	spawns_root.add_child(pen_e3)
	pen_e3.global_position = Vector3(-12, 0.5, -14)
	var pen_f4 := PENDRIVE.instantiate()
	pen_f4.kind = "fisico"
	spawns_root.add_child(pen_f4)
	pen_f4.global_position = Vector3(12, 0.5, 8)
	var pen_e4 := PENDRIVE.instantiate()
	pen_e4.kind = "especial"
	spawns_root.add_child(pen_e4)
	pen_e4.global_position = Vector3(-22, 0.5, 8)
	var pen_f5 := PENDRIVE.instantiate()
	pen_f5.kind = "fisico"
	...
	var pen_f6 := PENDRIVE.instantiate()
	pen_f6.kind = "fisico"
	spawns_root.add_child(pen_f6)
	pen_f6.global_position = Vector3(-8, 0.5, 18)
	var pen_e6 := PENDRIVE.instantiate()
...
func _dress_entry(root: Node3D) -> void:
	...
	_prop(root, "pottedPlant.glb", Vector3(1.5, 0, 20), -15.0)
	_prop(root, "bench.glb", Vector3(-8, 0, -18), 90.0)
	_prop(root, "bench.glb", Vector3(8, 0, -18), -90.0)
	_prop(root, "trashcan.glb", Vector3(-10, 0, -10), 25.0)
	_prop(root, "trashcan.glb", Vector3(10, 0, -10), -25.0)
	_prop(root, "pottedPlant.glb", Vector3(-16, 0, 4), 40.0)
	_prop(root, "pottedPlant.glb", Vector3(16, 0, 2), -40.0)
	_prop(root, "bench.glb", Vector3(0, 0, -26), 0.0)
	_prop(root, "trashcan.glb", Vector3(-18, 0, -8), 30.0)
	_prop(root, "trashcan.glb", Vector3(18, 0, -6), -30.0)
	_prop(root, "pottedPlant.glb", Vector3(-22, 0, 2), 50.0)
	_prop(root, "pottedPlant.glb", Vector3(22, 0, -2), -50.0)
	_prop(root, "bench.glb", Vector3(-14, 0, -22), 90.0)
	_prop(root, "bench.glb", Vector3(14, 0, -22), -90.0)
	_prop(root, "loungeSofa.glb", Vector3(-6, 0, 18), 0.0)
	_prop(root, "loungeSofa.glb", Vector3(6, 0, 18), 0.0)
	_prop(root, "trashcan.glb", Vector3(0, 0, 22), 0.0)
	_prop(root, "pottedPlant.glb", Vector3(-3, 0, 22), 20.0)
	_prop(root, "pottedPlant.glb", Vector3(3, 0, 22), -20.0)
	_prop(root, "trashcan.glb", Vector3(-4, 0, -28), 15.0)
	_prop(root, "trashcan.glb", Vector3(4, 0, -28), -15.0)
	_prop(root, "pottedPlant.glb", Vector3(-6, 0, -26), 40.0)
	_prop(root, "pottedPlant.glb", Vector3(6, 0, -26), -40.0)
	_prop(root, "bench.glb", Vector3(-12, 0, -28), 90.0)
	_prop(root, "bench.glb", Vector3(12, 0, -28), -90.0)
	_prop(root, "pottedPlant.glb", Vector3(-18, 0, 14), 30.0)
	_prop(root, "pottedPlant.glb", Vector3(18, 0, 12), -30.0)
	_prop(root, "trashcan.glb", Vector3(-8, 0, 20), 10.0)
	_prop(root, "trashcan.glb", Vector3(8, 0, 20), -10.0)
	...
	_emissive_box(Vector3(0, 0.05, -12), Vector3(1.3, 0.03, 0.5), Color(0.1, 0.08, 0.12), Color(0.9, 0.35, 0.45), 0.7)
	_emissive_box(Vector3(0, 0.05, -18), Vector3(1.2, 0.03, 0.45), Color(0.12, 0.06, 0.1), Color(1.0, 0.3, 0.4), 0.85)
	_emissive_box(Vector3(0, 0.05, -24), Vector3(1.4, 0.03, 0.5), Color(0.14, 0.05, 0.08), Color(1.0, 0.25, 0.35), 1.0)
	_emissive_box(Vector3(-6, 0.04, 2), Vector3(0.9, 0.03, 0.4), Color(0.1, 0.12, 0.1), Color(1.0, 0.55, 0.25), 0.6)
	_emissive_box(Vector3(6, 0.04, 2), Vector3(0.9, 0.03, 0.4), Color(0.08, 0.1, 0.14), Color(0.45, 0.75, 1.0), 0.6)
	_emissive_box(Vector3(-6, 0.04, -14), Vector3(0.85, 0.03, 0.38), Color(0.12, 0.1, 0.08), Color(0.95, 0.7, 0.3), 0.55)
	...
	_street_lamp(Vector3(8, 0, -30))
	_street_lamp(Vector3(-16, 0, -18))
	_street_lamp(Vector3(16, 0, -18))
	_street_lamp(Vector3(-20, 0, -24))
	_street_lamp(Vector3(20, 0, -22))
	_street_lamp(Vector3(-28, 0, -6))
	_street_lamp(Vector3(28, 0, -10))
	_street_lamp(Vector3(-28, 0, -24))
	_street_lamp(Vector3(28, 0, -24))
...
func _dress_bandejao(root: Node3D) -> void:
	...
	_prop(root, "trashcan.glb", center + Vector3(0, 0, -4.8), 0.0)
	_prop(root, "pottedPlant.glb", center + Vector3(0, 0, 4.8), 180.0)
...
func _dress_lab(root: Node3D) -> void:
	...
	_prop(root, "bookcaseOpen.glb", center + Vector3(-4.5, 0, -2.0), 90.0)
	_prop(root, "laptop.glb", center + Vector3(0, 0.78, 4.0), 0.0)
	_prop(root, "desk.glb", center + Vector3(0, 0, 4.2), 0.0)
	_prop(root, "chairDesk.glb", center + Vector3(0, 0, 3.0), 0.0)
	_emissive_box(center + Vector3(0, 0.08, 0), Vector3(0.4, 0.06, 3.5), Color(0.08, 0.1, 0.14), Color(0.4, 0.7, 1.0), 1.6)
	_emissive_box(center + Vector3(0, 0.06, 3.5), Vector3(2.0, 0.05, 0.5), Color(0.06, 0.08, 0.12), Color(0.5, 0.8, 1.0), 1.3)
...
func _dress_patio(root: Node3D) -> void:
	...
	_prop(root, "chair.glb", center + Vector3(-4.2, 0, 2.0), 200.0)
	_prop(root, "bench.glb", center + Vector3(4.5, 0, -4.0), 90.0)
