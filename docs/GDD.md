...
**Engine da entrega:** Unreal Engine 5, terceira pessoa, só Blueprint

Números de combate e balanceamento ficam em [NUMEROS.md](NUMEROS.md). Roteiro de produção:
[ROADMAP-unreal.md](ROADMAP-unreal.md). (O protótipo 2D em Pygame foi descontinuado para a
entrega do semestre; o design abaixo assume 3D.)
